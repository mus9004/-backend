...
router.post('/prod',(req, res)=>{
    ...
    mysqlConnection.query(`
        SELECT productos.idproductos, productos.descripcion,productos.peso, productos.unidadesCaja, unidadmedida.unidadMedida, categoria_productos.categoria, marca_prod.marca, genero_producto.genero, proveedor.proveedor, prod_presentacion.presentacioncol, productos.activo
        FROM productos 
